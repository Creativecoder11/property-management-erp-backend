...
-- CreateEnum
CREATE TYPE "LeadSource" AS ENUM ('DIRECT', 'FACEBOOK', 'WEBSITE', 'REFERRAL', 'WHATSAPP', 'CALL', 'WALK_IN', 'OTHER');

-- CreateEnum
CREATE TYPE "LeadStage" AS ENUM ('NEW', 'CONTACTED', 'INTERESTED', 'SITE_VISIT', 'NEGOTIATION', 'BOOKED', 'LOST');

-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('CALL', 'EMAIL', 'MEETING', 'SITE_VISIT', 'WHATSAPP', 'NOTE', 'FOLLOW_UP');
