...
let UnitsController = class UnitsController {
    ...
    matrix(id) { return this.service.getAvailabilityMatrix(id); }
    findOne(id) { return this.service.findOne(id); }
    create(dto) { return this.service.create(dto); }
    update(id, dto) { return this.service.update(id, dto); }
    updateStatus(id, body) { return this.service.updateStatus(id, body.status); }
};
...
__decorate([
    (0, common_1.Get)('matrix/:projectId'),
    __param(0, (0, common_1.Param)('projectId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], UnitsController.prototype, "matrix", null);
__decorate([
    (0, common_1.Get)(':id'),
